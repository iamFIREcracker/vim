...
if exists("g:loaded_matchparen_vendor") || &cp
  finish
endif
let g:loaded_matchparen_vendor = 1
...
if !exists("g:matchparen_hl_cursor")
  let g:matchparen_hl_cursor = 1
endif
